...
public:
    ...
    std::vector<ChatCommand> GetCommands() const override
    {
        ...
        static std::vector<ChatCommand> reloadCommandTable =
        {
			...
			{ "npcteleport_location",		   rbac::RBAC_PERM_COMMAND_RELOAD_NPCTELEPORT_LOCATION,			    true,  &HandleReloadNPCTeleportLocation,			   "" },
			{ "npcloyalty_rewards",			   rbac::RBAC_PERM_COMMAND_RELOAD_NPCLOYALTY_REWARDS,			    true,  &HandleReloadNPCLoyalty,			               "" },
			{ "autolearnspells",			   rbac::RBAC_PERM_COMMAND_RELOAD_AUTOLEARN_SPELLS,				    true,  &HandleReloadAutoLearnSpells,			               "" },
			{ "account_mount_data",			   rbac::RBAC_PERM_COMMAND_RELOAD_ACCOUNT_MOUNT_DATA,				true,  &HandleReloadAcountMountData,			               "" },
    ...
    static bool HandleReloadAllSpellCommand(ChatHandler* handler, char const* /*args*/)
    {
		...
		HandleReloadAutoLearnSpells(handler, "a");
		HandleReloadAcountMountData(handler, "a");
        return true;
    }
    ...
    static bool HandleReloadAllGossipsCommand(ChatHandler* handler, char const* args)
    {
        ...
        HandleReloadPointsOfInterestCommand(handler, "a");
		HandleReloadNPCTeleportLocation(handler, "a");
		HandleReloadNPCLoyalty(handler, "a");
        return true;
    }
	...
	static bool HandleReloadNPCTeleportLocation(ChatHandler* handler, const char* /*args*/)
	{
		TC_LOG_INFO("misc", "Reloading npcTeleport_Locations table...");
		  LoadNpcTele();
		handler->SendGlobalGMSysMessage("NPC Teleport reloaded.");
		return true;
	}
	static bool HandleReloadNPCLoyalty(ChatHandler* handler, const char* /*args*/)
	{
		TC_LOG_INFO("misc", "Reloading npcTeleport_Locations table...");		
		LoadNpcLoyalty();
		handler->SendGlobalGMSysMessage("NPC Loyalty reloaded.");
		return true;
	}
	static bool HandleReloadAutoLearnSpells(ChatHandler* handler, const char* /*args*/)
	{
		TC_LOG_INFO("misc", "Reloading AutoLearn table...");
		sAutoLearnItems->LoadAutoLearn();
		handler->SendGlobalGMSysMessage("AutoLearn reloaded.");
		return true;
	}
