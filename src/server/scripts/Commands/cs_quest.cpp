...
public:
    ...
    static bool HandleQuestAdd(ChatHandler* handler, char const* args)
    {
        ...
        if (handler->GetSession()->GetSecurity() <= 1 && player != handler->GetSession()->GetPlayer())
        {
            player = handler->GetSession()->GetPlayer();
            ChatHandler chat(handler->GetSession());
            std::string msg = "Con tu nivel de GM, solo puedes darte quest a ti mismo";
    ...
    static bool HandleQuestRemove(ChatHandler* handler, char const* args)
    {
        ...
        if (handler->GetSession()->GetSecurity() <= 1 && player != handler->GetSession()->GetPlayer())
        {
            player = handler->GetSession()->GetPlayer();
            ChatHandler chat(handler->GetSession());
            std::string msg = "Con tu nivel de GM, solo puedes quitarte quest a ti mismo";
            chat.SendSysMessage(msg.c_str());
        }
        // .removequest #entry'
        // number or [name] Shift-click form |color|Hquest:quest_id:quest_level|h[name]|h|r
    ...
    static bool HandleQuestComplete(ChatHandler* handler, char const* args)
    {
        ...
        if (handler->GetSession()->GetSecurity() <= 1 && player != handler->GetSession()->GetPlayer())
        {
            player = handler->GetSession()->GetPlayer();
            ChatHandler chat(handler->GetSession());
            std::string msg = "Con tu nivel de GM, solo puedes completarte quest a ti mismo";
            chat.SendSysMessage(msg.c_str());
        }
    ...
    static bool HandleQuestReward(ChatHandler* handler, char const* args)
    {
        ...
        if (handler->GetSession()->GetSecurity() <= 1 && player != handler->GetSession()->GetPlayer())
        {
            player = handler->GetSession()->GetPlayer();
            ChatHandler chat(handler->GetSession());
            std::string msg = "Con tu nivel de GM, solo puedes recompensarte quest a ti mismo";
            chat.SendSysMessage(msg.c_str());
        }
