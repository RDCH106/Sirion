            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                ...
                case EVENT_DEFILE:
                    ...
                    if (events.IsInPhase(PHASE_TWO))
                        events.ScheduleEvent(EVENT_SUMMON_VALKYR, urand(10000, 15000), 0, PHASE_TWO_THREE);
                    else
                ...
                case EVENT_SUMMON_VALKYR:
                    ...
                    {
                        events.ScheduleEvent(EVENT_DEFILE, urand(1000, 1000), 0, PHASE_TWO_THREE);
                        break;
                    }                       
                    me->GetMap()->SetZoneMusic(AREA_ICECROWN_CITADEL, MUSIC_SPECIAL);
                    ...
                    events.ScheduleEvent(EVENT_DEFILE, urand(15000, 20000), 0, PHASE_TWO_THREE);
