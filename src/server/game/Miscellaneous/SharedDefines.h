...
enum Races
{
    ...
    RACE_BLOODELF           = 10,
    RACE_DRAENEI            = 11,
    RACE_ALIANCE_BLOOD_ELF  = 12,
    RACE_NAGA               = 13,
    RACE_HORDE_NIGHT_ELF    = 14,
    RACE_PANDAREN_HOR       = 15, 
    RACE_HUARGUEN_WOLF      = 16, 
    RACE_PANDAREN_ALI       = 17, 
    RACE_HUARGUEN_HUMAN     = 18,
    RACE_TAUNKA             = 19,
...
#define RACEMASK_ALL_PLAYABLE \
    ((1<<(RACE_HUMAN-1))   |(1<<(RACE_ORC-1))          |(1<<(RACE_DWARF-1))   | \
     ...
     (1<<(RACE_GOBLIN-1))   |(1<<(RACE_ALIANCE_BLOOD_ELF-1))        |(1<<(RACE_NAGA-1))| \
     (1<<(RACE_HORDE_NIGHT_ELF-1))   |(1<<(RACE_PANDAREN_HOR-1))        |(1<<(RACE_HUARGUEN_WOLF-1))| \
     (1<<(RACE_PANDAREN_ALI-1))   |(1<<(RACE_HUARGUEN_HUMAN-1))        |(1<<(RACE_TAUNKA-1))| \
...
#define RACEMASK_ALLIANCE     \
    ((1<<(RACE_HUMAN-1))    | \
     ...
     (1<<(RACE_GNOME-1))    | \
     (1<<(RACE_DRAENEI-1))  | \
     (1<<(RACE_HUARGUEN_WOLF-1))   | \
     (1<<(RACE_HUARGUEN_HUMAN-1))   | \
     (1<<(RACE_PANDAREN_ALI-1)))
...
enum GossipNPCHelloRequest
{
	LOYALTY_GOSSIP_HELLO_REQUEST,
	TELEPORT_GOSSIP_HELLO_REQUEST,
	ARENA_SPECTATOR_GOSSIP_HELLO_REQUEST,
	TRANSMORG_GOSSIP_HELLO_REQUEST,
	LOYALTY_SHOP_HELLO_REQUEST,
    TRAVELER_GUIDE_HELLO_REQUEST,
	MAX_GOSSIP_HELLO_REQUEST
};

enum GossipItemHelloRequest
{
    GUILD_RENAME,
    PLAYER_UNBAN,
    PLAYER_BOOST,
