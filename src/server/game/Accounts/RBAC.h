...
namespace rbac
{
    ...
    enum RBACPermissions
    {
        ...
        RBAC_PERM_COMMAND_ANTICHEAT = 1000,
        RBAC_PERM_COMMAND_ANTICHEAT_GLOBAL = 1001,
        RBAC_PERM_COMMAND_ANTICHEAT_PLAYER = 1002,
        RBAC_PERM_COMMAND_ANTICHEAT_DELETE = 1003,
        RBAC_PERM_COMMAND_ANTICHEAT_HANDLE = 1004,
        RBAC_PERM_COMMAND_ANTICHEAT_JAIL = 1005,
        RBAC_PERM_COMMAND_ANTICHEAT_WARN = 1006,
        RBAC_PERM_COMMAND_RELOAD_NPCTELEPORT_LOCATION = 1007,
        RBAC_PERM_COMMAND_RELOAD_NPCLOYALTY_REWARDS = 1008,
        RBAC_PERM_COMMAND_GUILD_LINFO = 1009,
        RBAC_PERM_COMMAND_GUILD_SET_LEVEL = 1010,
        RBAC_PERM_COMMAND_GUILD_GIVE_XP = 1011,
        ...
        RBAC_PERM_COMMAND_RELOAD_AUTOLEARN_SPELLS = 1017,
        RBAC_PERM_COMMAND_RELOAD_ACCOUNT_MOUNT_DATA = 1018,
        RBAC_PERM_COMMAND_GOSSIP_REQUEST = 1019,
        RBAC_PERM_COMMAND_LOYALTY_SHOP = 1020,
        RBAC_PERM_COMMAND_HAS_PATCHS = 1021,
        RBAC_PERM_COMMAND_LOYALTY_UPDATE_POINTS = 1022,
        RBAC_PERM_COMMAND_GOBJECT_ACTIVE_LOOT = 1023,
        RBAC_PERM_COMMAND_NEWS = 1024,
        RBAC_PERM_COMMAND_NEWS_SET = 1025,
        RBAC_PERM_COMMAND_NEWS_PREVIEW = 1026,
        RBAC_PERM_COMMAND_NEWS_FLUSH = 1027,
