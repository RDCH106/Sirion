        ...
        if (team == winner)
        {
            if (IsRandom() || BattlegroundMgr::IsBGWeekend(GetTypeID()))
            {
                ...
                if (!player->GetRandomWinner())
                {
                    ...
                    {
                    case CLASS_WARRIOR:
                        player->AddItem(32551, 1);
                        break;
                    case CLASS_PALADIN:
                        player->AddItem(32552, 1);
                        break;
                    case CLASS_HUNTER:
                        player->AddItem(32554, 1);
                        break;
                    case CLASS_ROGUE:
                        player->AddItem(32559, 1);
                        break;
                    case CLASS_PRIEST:
                        player->AddItem(32556, 1);
                        break;
                    case CLASS_DEATH_KNIGHT:
                        player->AddItem(32550, 1);
                        break;
                    case CLASS_SHAMAN:
                        player->AddItem(32553, 1);
                        break;
                    case CLASS_MAGE:
                        player->AddItem(32557, 1);
                        break;
                    case CLASS_WARLOCK:
                        player->AddItem(32558, 1);
                        break;
                    case CLASS_DRUID:
                        player->AddItem(32555, 1);
                        break;
                    default:
                        break;
                    }
