...
bool LootStoreItem::Roll(bool rate) const
{
	...
	//Compruebo las subclases segun tabla para aplicar un segundo modificador
	if (pProto && rate && pProto->Class == 7 && pProto->SubClass >= 1 && pProto->SubClass <= 12 && pProto->SubClass != 2 && pProto->SubClass != 3 && pProto->SubClass != 11)
		qualityModifier = sWorld->getRate(RATE_DROP_ITEM_CRAFT); 
