...
class TC_GAME_API Item : public Object
{
    ...
    public:
        ...
        //Lo añado para enviar items engemados por mail
        void SetEnchantment(EnchantmentSlot slot, uint32 id, Player* owner, uint32 duration, uint32 charges, ObjectGuid caster = ObjectGuid::Empty);
