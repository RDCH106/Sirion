...
void Unit::_AddAura(UnitAura* aura, Unit* caster)
{
    if (m_cleanupDone)
    {
        ...
        {
            std::string str = "";
            str = "ERROR->Unit::_AddAura->Player:";
            str += owner->GetName();
            str += "->Aura: ";
            str += std::to_string(aura->GetId());
...
void Unit::Dismount()
{
    ...
    //{
    //    //Desmarco la montura
    //    PreparedStatement* stmt = CharacterDatabase.GetPreparedStatement(CHAR_REP_MOUNT);
    ...
    /*if (Player* player = ToPlayer())
    {
        SetUInt32Value(PLAYER_MOUNT_ID, 0);
        CharacterDatabase.PExecute("replace into character_mount (guid,spell) value (%u,%u)", player->GetGUID(), 0);
    }*/
    ...
    if (GetTypeId() == TYPEID_PLAYER)
    {
        ...
        case FORM_CAT:
            ...
            if (getRace() == RACE_HUARGUEN_WOLF)
            {
                ...
                case 1: // Light Blue
                    return 1934; // 16245 - 1.14999997615814
                case 2: // Dark Green
                    return 15591; //listo  15591 - 1.14999997615814
                default: // original - Dark Blue
                   // return 892;
                    return 892;
                }
            ...
            if (getRace() == RACE_TROLL)
            {
                ...
                case 0: // Violet
                case 1:
                    return 1008; //listo  0.850000023841858
                case 3: // Green
                case 4: // Light Green
                    return 1058; //listo  0.850000023841858
                case 6: // White
                case 7: // White
                    return 1971; //listo  0.850000023841858
                default: // original
                    return 8571;
                }
            }
        ...
        case FORM_BEAR:
            ...
            if (getRace() == RACE_HUARGUEN_WOLF)
            {
                ...
                case 1: // Light Blue
                    return 822; // 16245 - 1.14999997615814
                case 2: // Dark Green
                    return 719; //listo  15591 - 1.14999997615814
                default: // original - Dark Blue
                   // return 892;
                    return 2281;
                }
            ...
            if (getRace() == RACE_TROLL)
            {
                ...
                case 0: // Violet
                case 1:
                    return 11908; //listo  5510
                case 3: // Green
                case 4: // Light Green
                    return 2378; //listo  0.850000023841858
                case 6: // White
                case 7: // White
                default: // original
                    return 2289;
...
uint32 Unit::GetModelForTotem(PlayerTotemType totemType)
{
    ...
    case RACE_GOBLIN:
    {
        switch (totemType)
        {
        case SUMMON_TYPE_TOTEM_FIRE:    // fire   30783  // 1529 ROJO CON SERPIENTE
            return 1529;
        case SUMMON_TYPE_TOTEM_EARTH:   // earth  30782  // 2030 MARRON
            return 2030;
        case SUMMON_TYPE_TOTEM_WATER:   // water  30784  // 2418 AZULADO
            return 2418;
        case SUMMON_TYPE_TOTEM_AIR:     // air    30781  //  2419 VERDE
            return 2419;
        }
        break;
    }
    case RACE_PANDAREN_HOR:
    {
        switch (totemType)
        {
        case SUMMON_TYPE_TOTEM_FIRE:    // fire   30783  // 4683 ROJO	25585
            return 25585;
        case SUMMON_TYPE_TOTEM_EARTH:   // earth  30782  // 1421 ROJO	3731
            return 3731;
        case SUMMON_TYPE_TOTEM_WATER:   // water  30784  // 			22162 GOLEM DE LA COSECHA
            return 22162;
        case SUMMON_TYPE_TOTEM_AIR:     // air    30781  // 23229		17707
            return 17707;
        }
        break;
    }
