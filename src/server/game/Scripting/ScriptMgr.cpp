...
void ScriptMgr::OnGossipSelect(Player* player, Item* item, uint32 menuId, uint32 gossipListId)
{
	...
	tmpscript->GossipSelect(player, item, menuId, gossipListId);
}
...
void ScriptMgr::OnGossipSelectCode(Player* player, Item* item, uint32 menuId, uint32 gossipListId, const char* code)
{
	...
	GET_SCRIPT(ItemScript, item->GetScriptId(), tmpscript);
	tmpscript->GossipSelectCode(player, item, menuId, gossipListId, code);
}
...
void ScriptMgr::OnGossipSelect(Player* player, uint32 menuId, uint32 gossipListId)
{
	FOREACH_SCRIPT(PlayerScript)->GossipSelect(player, menuId, gossipListId);
}

void ScriptMgr::OnGossipSelectCode(Player* player, uint32 menuId, uint32 gossipListId , const char* code)
{
	FOREACH_SCRIPT(PlayerScript)->GossipSelectCode(player, menuId, gossipListId, code);
}

void ScriptMgr::OnGossipHelloRequest(Player* player)
{
