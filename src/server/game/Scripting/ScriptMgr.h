...
public:
	...
	virtual void GossipSelect(Player* /*player*/, Item* /*item*/, uint32 /*menuId*/, uint32 /*gossipListId*/) { }

	// Called when a player selects an option in an item gossip window
	virtual void GossipSelectCode(Player* /*player*/, Item* /*item*/, uint32 /*menuId*/, uint32 /*gossipListId*/, const char* /*code*/) { }
};
...
public:
	...
	virtual void GossipSelect(Player* /*player*/, uint32 /*menuId*/, uint32 /*gossipListId*/) { }

	// Called when a player selects an option in a player gossip window
	virtual void GossipSelectCode(Player* /*player*/, uint32 /*menuId*/, uint32 /*gossipListId*/, const char* /*code*/) { }

	// Called when a GossipHelloRequest
	virtual void GossipHelloRequest(Player* /*player*/) { }
...
public: /* ItemScript */
	...
	void OnGossipSelect(Player* player, Item* item, uint32 menuId, uint32 gossipListId);
	void OnGossipSelectCode(Player* player, Item* item, uint32 menuId, uint32 gossipListId, const char* code);
...
public: /* PlayerScript */
	...
	void OnGossipSelect(Player* player, uint32 menuId, uint32 gossipListId);
	void OnGossipSelectCode(Player* player, uint32 menuId, uint32 gossipListId, const char* code);
