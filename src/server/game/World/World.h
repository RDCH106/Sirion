...
enum WorldIntConfigs
{
    ...
    CONFIG_START_HORDE_NIGHT_ELF_PLAYER_LEVEL,
    CONFIG_START_ALIANCE_BLOOD_ELF_PLAYER_LEVEL,
    CONFIG_START_HORDE_PANDAREN_PLAYER_LEVEL,
    CONFIG_START_ALIANCE_PANDAREN_PLAYER_LEVEL,
    CONFIG_START_HUARGUEN_PLAYER_LEVEL,
    CONFIG_START_GOBLIN_PLAYER_LEVEL,
    ...
    CONFIG_LOYALTY_NPC_POINTS,
    CONFIG_LOYALTY_1ST_BG,
    CONFIG_LOYALTY_REST_BG,
    CONFIG_LOYALTY_1ST_ALEH,
    CONFIG_LOYALTY_REST_ALEH,
    CONFIG_GUILD_HOUSE_TOKEN_OR_GOLD,
    CONFIG_GUILD_HOUSE_BUY_COST,
    CONFIG_GUILD_HOUSE_SELL_COST,
    CONFIG_PLAYER_TIMED_REWARD_GLOBAL_INTERVAL,
    CONFIG_PLAYER_TIMED_REWARD_MONEY_INTERVAL,
    CONFIG_PLAYER_TIMED_REWARD_HONOR_INTERVAL,
    CONFIG_PLAYER_TIMED_REWARD_ARENA_INTERVAL,
    CONFIG_PLAYER_TIMED_REWARD_LOYALTY_POINTS_INTERVAL,
    CONFIG_PLAYER_TIMED_REWARD_MONEY_AMOUNT,
    CONFIG_PLAYER_TIMED_REWARD_HONOR_AMOUNT,
    CONFIG_PLAYER_TIMED_REWARD_ARENA_AMOUNT,
    CONFIG_PLAYER_TIMED_REWARD_LOYALTY_POINTS_AMOUNT,
    CONFIG_LOYALTY_SHOP_WORLDSTATE,
    CONFIG_TMORG_COST,
