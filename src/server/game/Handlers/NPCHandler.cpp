...
void WorldSession::WorldSession::SendTrainerList(ObjectGuid guid)
{
    std::string str = GetTrinityString(LANG_NPC_TAINER_HELLO);
    SendTrainerList(guid, str);
}

void WorldSession::WorldSession::SendTrainerList(ObjectGuid guid, const std::string& strTitle)
{
